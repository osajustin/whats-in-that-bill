...
function BillCardSkeleton() {
  return (
    <div className="animate-pulse rounded-xl border border-navy-200 bg-white p-5">
      ...
      <div className="mb-3 space-y-2">
        <div className="h-6 w-full rounded bg-navy-200" />
        <div className="h-6 w-3/4 rounded bg-navy-200" />
      </div>
...
export function BillList({ bills, isLoading }: BillListProps) {
  ...
  if (bills.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-navy-200 bg-white/50 py-16 text-center">
        <svg
          className="mb-4 h-12 w-12 text-navy-300"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={1}
